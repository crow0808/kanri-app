...
ActiveRecord::Schema[7.0].define(version: 2023_12_24_142305) do
  create_table "manuals", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["room_id"], name: "index_manuals_on_room_id"
